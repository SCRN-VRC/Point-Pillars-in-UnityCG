            ...
            float frag (v2f i) : SV_Target
            {
                ...
                if (layerHash % primes[20] == 0)
                {
                    ...
                    for (uint n = 0; n < 64; n += 4) {
                        s += dot(
                            float4(
                                getLayer(_InputTex, 4, uint4(8, 8, 248, 216), uint3(l, m, n)),
                                getLayer(_InputTex, 4, uint4(8, 8, 248, 216), uint3(l, m, n + 1)),
                                getLayer(_InputTex, 4, uint4(8, 8, 248, 216), uint3(l, m, n + 2)),
                                getLayer(_InputTex, 4, uint4(8, 8, 248, 216), uint3(l, m, n + 3))
                            ),
                            float4(
